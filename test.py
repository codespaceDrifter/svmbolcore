...
test_string_9 = "(a + b) ** (c * d)"
expr_9 = parse_expr(test_string_9)
new_string_9 = str_flat(expr_9)
assert new_string_9 == test_string_9

# Pow with div base and div exponent (needs parentheses)
test_string_10 = " - 5 * a / b"
